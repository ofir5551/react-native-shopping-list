export const en = {
  ...
  'lists.emptyTitle': 'Ready to shop?',
  'lists.emptySubtitle': 'Tap + to create your first list.',
  ...
  'signup.photoSourceTitle': 'Profile Photo',
  'signup.takePhoto': 'Take Photo',
  'signup.chooseFromLibrary': 'Choose from Library',
